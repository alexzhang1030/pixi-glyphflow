...
- [Paid traps](gotchas.md) — CI Chrome/`float16x4` instance attributes, packed atlas keys vs `glyphText`, deferred atlas-pressure frame gate, compute-cull encoder hook, and never `queryAll` the million-label world into the 16,777,216 instance cap.
