...
- [100× performance path](performance-100x.md) — why compute-cull felt slower than cpu-grid, what 100× actually means on the homepage, shared prototype instance ranges, the first-seen admit lane, and the remaining slices (prototype-fetch instance mesh, first-seen unique raster, palette storage, rejected default baked pages).
